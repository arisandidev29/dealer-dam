	...
	<div class="grid grid-cols-2 md:grid-cols-4  gap-2 md:gap-4" >
		...
		<div class=" bg-rose-100 rounded-lg px-2 md:px-4 py-2 grid grid-cols-1 md:grid-cols-2  " >
			<div class="w-[90%] md:w-[80%] mx-auto self-center">
				<img src="{{ asset("storage/product.png") }}" alt="img">
			</div>
			<div class="pt-2 md:pt-4 row-start-2  md:row-span-1">
				
				<h2 class=" font-title text-center md:text-left text-lg md:text-2xl text-primary font-semibold ">CRF 150</h2>
				<p class="mt-2 md:mt-4 text-sm">harga</p>
				<p class="text-sm md:text-2xl font-semibold ">Rp. 22.220.00</p>
				<p class="text-xs md:text-sm mb-2 md:mb-4">Dibuat 10 mei 2024</p>
			</div>
